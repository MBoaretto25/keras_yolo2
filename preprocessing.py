        ...
        self.aug_pipe = iaa.Sequential(
            [
                ...
                sometimes(iaa.Affine(
                    scale={"x": (0.6, 1), "y": (0.6, 1)}, # scale images to 60-100% of their size, individually per axis
                ...
                iaa.SomeOf((0, 5),
                    [
                        sometimes(iaa.Superpixels(p_replace=(0, 0.4), n_segments=(20, 200))), # convert images into their superpixel representation
                        iaa.OneOf([
                        ...
                        iaa.OneOf([
                            ...
                            iaa.CoarseDropout((0.03, 0.15), size_percent=(0.1, 0.3), per_channel=0.2),
                        ]),
